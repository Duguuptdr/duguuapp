...
import { extracurricular } from "../Constant"; 
...
useEffect(() => {
  ...
  const skills = [
    { id: 1, name: "Java", image: "../assets/tech/java.png" },
    { id: 2, name: "HTML5", image: "../assets/tech/html.png" },
    { id: 3, name: "MySQL", image: "../assets/tech/mysql.png" },
    { id: 4, name: "Ubuntu", image: "../assets/tech/css.png" },
    { id: 5, name: "Placeholder", image: "../assets/tech/js.png" },
  ];
  ...
  return (
    <>
      <div className="ramExtrecurricular" >
<h2 className="ExtracurricularheadP"  data-aos="zoom-in">"My skills, awards, and activities."</h2>
      ...
      <div className="flex flex-wrap gap-4 p-4">
        {extracurricular.map((activity, index) => (
          <div key={index} className="flex flex-col items-center bg-gray-100 p-4 rounded-lg shadow-md">
            ...
            <img src={activity.icon} alt={activity.name} className="w-167 h-16" />
            <p className="mt-2 text-lg font-semibold" id='StudyHEad' >{activity. credential}</p>
            <p className="mt-2 text-lg font-semibold" id='StudyDate' >{activity.date}</p>
            <p className="mt-2 text-lg font-semibold" id='StudyTitle' >{activity.title}</p>
            <p className="mt-2 text-lg font-semibold" id='StudyED'>{activity.type}</p>
            {/* <p className="mt-2 text-lg font-semibold">{activity.name}</p> */}
            </div>
          </div>
        ))}
      </div></div></div>
