...
import { experiences } from "../Constant"; // Ensure correct import

import Congnizant from "./../assests/tech/Cognizant.png"
...
//   };
  ...
  return (<>
  <div className="ExperienceWOrk" id="Experience">
    <div className="boxBorderExperience">
<h2 className="EXperienceBack_ground" data-aos="zoom-in">'What I have done so far Work Experience.'</h2>
<div className="vertical-timeline">
    <div className="flex flex-wrap gap-4 p-4 Dg_div">
      {experiences.map((tech, index) => (
        ...
        >
            <div className="experiencesgroop">
            {/* <div
          ...
          <img src={Congnizant}  alt="Cognizant" className="w-167 h-16" id='StudyED' />
          <p className="mt-2 text-lg font-semibold color-white" id='StudyED'>{tech.name}</p> 
          <p className="mt-2 text-lg font-semibold" id='StudyHEad'>Company Name:{tech.company_name}</p> 
          <p className="mt-2 text-lg font-semibold" id='StudyDate'>{tech.date}</p> 
          <p className="mt-2 text-lg font-semibold"  id='StudyTitle'>{tech.title}</p> 
          <p className="mt-2 text-lg font-semibold" id='StudyED'>{tech.
points
}</p> </div>
          {/* Fixed name */}
        </div></div>
